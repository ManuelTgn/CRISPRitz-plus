# Contributing to CRISPRitz+

Thank you for your interest in contributing to **CRISPRitz+**!
...
2. If it's new, [open a new issue](https://github.com/pinellolab/CRISPRitz-plus/issues/new) and include:
   ...
   * System info: OS, Python version, C++ compiler version, CRISPRitz+ version
...
Thank you for contributing to **CRISPRitz+**! 🧬🔍
